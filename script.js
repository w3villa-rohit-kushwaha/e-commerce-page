...
categories.forEach(function(category) {
  category.addEventListener("click", function() {
    // remove the "active-why-buy" class from all categories
    categories.forEach(function(category) {
      category.classList.remove("active-why-buy");
    });
    // add the "active-why-buy" class to the clicked category
    this.classList.add("active-why-buy");
...
function loadContent1(category) {
  let contentContainer = document.getElementById("product-list")
...
.catch(error => console.error(error));
      break;
    default:
      // default to loading all content
      // load all content
      break;
  }
}

// Load the "all" category content by default
loadContent1("all");



const categories2 = document.querySelectorAll(".category2");
...
function loadContent(category) {
  let contentContainer = document.getElementById("product-list-2");
  // clear the content container
  contentContainer.innerHTML = "";
